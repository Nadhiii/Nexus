...
## Corpus Check
- 378 files · ~330,146 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7698 nodes · 10565 edges · 374 communities (346 shown, 28 thin omitted)
...
- nexus_switch.dart
- goal.dart
- transaction_match_service.dart
- more_screen.dart
- gmail_provider.dart
...
- MessageHandler
- TestShadcnInstaller
- transaction_brain_service.dart
- pay_debt_modal.dart
- knowledge_base.dart
...
- transaction_draft.dart
- .application
- Nexus — Integration Status
- google_drive_service.dart
- Brand Guidelines Template
- add_account_screen.dart
- statement_reconciliation_service.dart
- radius
- spring_tap.dart
...
- MaterialPageRoute
- BiometricProvider
- legacy_data_migration_service.dart
- bool get
...
9. `NewNboxProvider` - 34 edges
10. `CategoryProvider` - 32 edges
...
## Communities (374 total, 28 thin omitted)

### Community 0 - "BikeProvider"
Cohesion: 0.04
Nodes (50): ../../core/providers/bike_provider.dart, ../../../core/utils/bike_image_utils.dart, BikeProvider, build, _buildListTile, createState, GarageManagementScreen, _GarageManagementScreenState (+42 more)
...
### Community 2 - "State"
Cohesion: 0.10
Nodes (62): ChangeNotifier, _AuthenticatedAppState, _AuthGateState, _clearAllProviders, _initializeCriticalProviders, _initializeDeferredProviders, AccountProvider, BudgetProvider (+54 more)

### Community 3 - "nbox_provider.dart"
Cohesion: 0.03
Nodes (78): category_provider.dart, dart:isolate, gmail_provider.dart, knowledge_provider.dart, _accountProvider, _analyzeAndAutomate, _automationInFlight, _automationService (+70 more)

### Community 4 - "nbox_screen.dart"
Cohesion: 0.03
Nodes (74): ../../core/widgets/top_notification.dart, NewNboxProvider, _animating, _attemptQueuedApproval, build, _buildActionButton, _buildAnalysisChip, _buildAutoRecordedSection (+66 more)

### Community 5 - "payday_screen.dart"
Cohesion: 0.04
Nodes (52): ../../core/models/payday_checklist.dart, ../../core/providers/account_provider.dart, ../../core/providers/budget_provider.dart, ../../core/providers/debt_provider.dart, ../../core/providers/family_debt_provider.dart, ../../core/providers/goal_provider.dart, ../../core/providers/subscription_provider.dart, ../../core/services/payday_checklist_service.dart (+44 more)
...
Cohesion: 0.06
Nodes (33): _allocatedAmountController, budget, build, _buildCommitmentDetail, _buildCommitmentsWidget, _buildLabel, _categories, _categoryNameController (+25 more)
...
Cohesion: 0.06
Nodes (38): IconData, build, DashboardCard, icon, onTap, subtitle, title, trend (+30 more)
...
Cohesion: 0.04
Nodes (51): ../../core/models/knowledge_entry.dart, ../../core/services/transaction_automation_service.dart, ../../core/services/transaction_intent_classifier.dart, ../../core/services/transaction_router.dart, _activeIntent, _animController, build, _buildAccountSelector (+43 more)
...
Cohesion: 0.06
Nodes (43): AutomaticKeepAliveClientMixin, ../../core/providers/dashboard_preferences_provider.dart, ../../core/widgets/animated_list_item.dart, ../../core/widgets/total_balance_card.dart, DashboardPreferencesProvider, _ActionBar, _BentoBudgetsCard, _BentoCardContainer (+35 more)
...
Cohesion: 0.06
Nodes (35): activeSubscriptionCount, addSubscription, _checkSubscriptionReminders, clear, clearAllData, deleteSubscription, dispose, _dueToday (+27 more)
...
Cohesion: 0.06
Nodes (32): ../../core/providers/category_provider.dart, ../../core/services/transaction_intelligence_service.dart, ../../core/services/transaction_match_service.dart, ../../core/utils/transaction_display.dart, build, CategorySpendingChart, transactions, accountId (+24 more)
...
Cohesion: 0.10
Nodes (20): add_bike.dart, dart:math, Bike, _animation, bike, build, _buildBack, _buildBadge (+12 more)
...
### Community 27 - "knowledge_service.dart"
Cohesion: 0.11
Nodes (18): knowledge_service.dart, KnowledgeLearningService, _knowledgeService, _learn, learnCategory, learnCounterpartyRole, learnPurpose, _auth (+10 more)

### Community 28 - "knowledge_provider.dart"
Cohesion: 0.07
Nodes (28): autoApprovalEligible, clear, deleteMerchantKnowledge, dispose, _entries, _error, _firestore, forget (+20 more)
...
Cohesion: 0.07
Nodes (28): AddLoanModal, AddLoanSheet, _amountController, _balanceController, build, _buildDirectionTab, _buildField, _buildLabel (+20 more)

### Community 33 - "wallet_screen.dart"
Cohesion: 0.04
Nodes (46): ../accounts/account_detail_screen.dart, ../accounts/add_account_screen.dart, _animation, _applyInitialTab, _BalanceStatus, build, _buildAccountsList, _buildBack (+38 more)
...
Cohesion: 0.08
Nodes (24): app_animations.dart, app_colors.dart, app_spacing.dart, app_typography.dart, Debt, AppTheme, theme, _amountController (+16 more)
...
Cohesion: 0.05
Nodes (38): analyze, _calculateConfidence, _calculateNameSimilarity, _calculateOverallHealth, _calculatePriority, _calculateProjection, confidenceScore, data (+30 more)
...
Cohesion: 0.07
Nodes (29): ../bike/ui/bike_screen.dart, ../../core/widgets/spring_tap.dart, build, _buildBottomActionButton, _buildExpressiveDownloadButton, _buildSectionHeader, _buildSettingsSection, _buildSupportSection (+21 more)

### Community 45 - "gmail_provider.dart"
Cohesion: 0.06
Nodes (34): DateTime? get, GmailSyncSettings get, GoogleSignInAccount?, GoogleSignInAccount? get, _authSubscription, _currentUser, _detectedTransactions, dispose (+26 more)
...
Cohesion: 0.06
Nodes (34): amount, avatarUrl, category, copyWith, createdAt, date, description, email (+26 more)
...
Cohesion: 0.10
Nodes (19): _budgetsCollection, BudgetService, calculateSpentAmount, cloneBudgetsFromPreviousPeriod, createBudget, createMonthlyBudgets, deleteBudget, _firestore (+11 more)

### Community 63 - "bike_screen.dart"
Cohesion: 0.06
Nodes (32): build, _buildActionChip, _buildBikeSelector, _buildEmptyState, _buildRadioListTile, _buildTimelineList, createState, _currentFuelPrice (+24 more)
...
Cohesion: 0.06
Nodes (32): analyze, _findTransferPeer, _intelligence, resolveAccount, resolveDestinationAccount, TransactionAutomationService, tryAutoRecord, _amountAnomaly (+24 more)
...
Cohesion: 0.06
Nodes (33): @pragma, dart:async, _channel, initialize, _initialized, IntentNavigationService, _tabController, tabStream (+25 more)

### Community 71 - "recurring_template.dart"
Cohesion: 0.06
Nodes (31): int?, int get, accountId, amount, autoCreate, calculateNextDueDate, categoryId, commonTemplates (+23 more)
...
Cohesion: 0.05
Nodes (44): Animation, AnimationController, AnimatedListItem, _AnimatedListItemState, build, child, _controller, createState (+36 more)
...
Cohesion: 0.12
Nodes (16): _challans, _challanService, createChallan, deleteChallan, _error, expiringChallans, fetchVehicleChallans, _isLoading (+8 more)

### Community 78 - "add_credit_card_sheet.dart"
Cohesion: 0.07
Nodes (29): AddCreditCardModal, AddCreditCardSheet, _balanceController, _bankController, build, _buildGlassTextField, _buildLabel, _buildLivePreview (+21 more)
...
Cohesion: 0.07
Nodes (28): Key, _animationController, build, _buildBackground, child, confirmMessage, confirmTitle, createState (+20 more)
...
### Community 89 - "cross_module_notification_hub.dart"
Cohesion: 0.14
Nodes (13): CrossModuleNotificationHub, _generateBudgetNotifications, _generateCrossModuleNotifications, _generateDebtNotifications, _generateGoalNotifications, _generateInvestmentNotifications, generateNotifications, _generateSubscriptionNotifications (+5 more)

### Community 90 - "biometric_protected_action.dart"
Cohesion: 0.12
Nodes (16): BiometricAuthWrapper, build, child, BiometricProtectedButton, build, child, confirmationMessage, confirmationTitle (+8 more)
...
Cohesion: 0.07
Nodes (29): build, _buildField, _buildLabel, _buildTypeChip, createState, _currentController, dispose, _fetchNav (+21 more)
...
Cohesion: 0.05
Nodes (40): account, accountId, accountNumber, amount, analysis, balanceAfter, bankName, body (+32 more)

### Community 101 - "investment.dart"
Cohesion: 0.07
Nodes (27): copyWith, currentAmount, folioNumber, fromFirestore, id, investedAmount, Investment, InvestmentType (+19 more)
...
Cohesion: 0.08
Nodes (25): ../../core/providers/transaction_provider.dart, ../../../core/services/expense_trend_service.dart, build, _buildBudgetGuidance, _buildCompactView, _buildEmptyState, _buildForecastCard, _buildFullView (+17 more)

### Community 107 - "nexus_card.dart"
Cohesion: 0.14
Nodes (13): Border?, BorderRadius?, EdgeInsetsGeometry?, border, borderRadius, build, child, color (+5 more)
...
Cohesion: 0.09
Nodes (23): ../../core/widgets/app_dialog.dart, ../../core/widgets/translucent_app_bar.dart, amount, _amountController, build, _categories, category, color (+15 more)
...
Cohesion: 0.05
Nodes (39): ../../core/services/backup_service.dart, ../../core/widgets/nexus_button.dart, ../../core/widgets/nexus_empty_state.dart, ../../core/widgets/nexus_error_state.dart, ../../core/widgets/nexus_initial_loading.dart, BackupService, _autoBackupEnabled, _autoRestoreEnabled (+31 more)

### Community 129 - "debt_provider.dart"
Cohesion: 0.12
Nodes (15): double get, addDebt, _auth, clear, clearAllData, _debts, deleteDebt, _error (+7 more)
...
Cohesion: 0.10
Nodes (21): add_investment_screen.dart, ../../core/models/investment.dart, ../../core/providers/investment_provider.dart, ../../core/widgets/animated_number_text.dart, _assetPriorityScore, build, _buildAssetBentoGrid, _buildEmptyState (+13 more)
...
### Community 136 - "pdf_statement.dart"
Cohesion: 0.04
Nodes (56): accountHolder, accountNumber, accountType, amount, balance, bankName, closingBalance, confidenceScore (+48 more)
...
Cohesion: 0.10
Nodes (20): ../core/services/intent_navigation_service.dart, ../core/services/notification_service.dart, _approvalSub, build, _buildDockNavItems, _buildKuveraFloatingDock, createState, _currentIndex (+12 more)

### Community 139 - "fuel_price_provider.dart"
Cohesion: 0.09
Nodes (22): FuelPrice? get, _autoDetectLocation, _currentPrice, detectAndLoadCity, _error, _fuelPriceService, _initSafely, _isLoading (+14 more)
...
### Community 141 - "StatefulWidget"
Cohesion: 0.05
Nodes (37): biometric_auth_wrapper.dart, AuthenticatedApp, AuthGate, _biometricInitializationComplete, build, createState, _deferredInitializationScheduled, _initializedNotifications (+29 more)
...
Cohesion: 0.05
Nodes (36): add_account_screen.dart, ../../core/models/transaction.dart, ../../core/services/pdf_statement_import_service.dart, ../../core/services/statement_import_review_screen.dart, ../../core/utils/currency_formatter.dart, AppCurrency, CurrencyFormatting, _format (+28 more)
...
Cohesion: 0.09
Nodes (21): KnowledgeSource, active, confidence, context, copyWith, createdAt, _date, evidence (+13 more)
...
Cohesion: 0.11
Nodes (17): isDarkMode, _loadPreferences, _themeMode, ThemeProvider, toggleTheme, clearSelectedCity, getCurrentCity, getSelectedCity (+9 more)
...
Cohesion: 0.04
Nodes (50): aliases, AmountRange, average, canAutoCategorize, category, categoryHistory, confidence, copyWith (+42 more)
...
Cohesion: 0.10
Nodes (20): ../../../core/models/user_profile.dart, _animationController, build, createState, _displayNameController, dispose, EditProfileModal, _EditProfileModalState (+12 more)
...
Cohesion: 0.06
Nodes (30): ../../../core/models/budget.dart, ../../../core/models/goal.dart, Goal, build, goal, GoalTrackerWidget, abs, actionLabel (+22 more)
...
### Community 177 - "transaction_brain_service.dart"
Cohesion: 0.05
...
Cohesion: 0.10
Nodes (20): _amountController, build, _buildActions, _buildContent, _buildHeader, _controller, createState, debt (+12 more)

### Community 179 - "knowledge_base.dart"
Cohesion: 0.06
Nodes (30): AccountType, AccountKnowledge, accountNumberLast4, accounts, AccountType, autoLearnEnabled, autoLearnThreshold, bankName (+22 more)
...
Cohesion: 0.11
Nodes (17): areWidgetsSupported, _channel, data, getGarageWidgetCount, HomeScreenWidgetService, refreshAllWidgets, requestPinBalanceWidget, requestPinGarageWidget (+9 more)

### Community 182 - "account_service.dart"
Cohesion: 0.13
Nodes (14): AccountService, addAccount, clearAllAccounts, deleteAccount, _firestore, _getAccountsCollection, getDefaultColor, getDefaultIcon (+6 more)

### Community 183 - "add_debt_screen.dart"
Cohesion: 0.07
Nodes (29): AddDebtModal, _balanceController, build, _buildDatePicker, _buildField, _buildLabel, _buildTypeChip, createState (+21 more)

### Community 184 - "add_family_member.dart"
Cohesion: 0.12
Nodes (17): class, ../../../core/models/shared_expense.dart, ../../../core/providers/shared_expense_provider.dart, ../../../core/services/firestore_service.dart, FamilyMember, build, createState, dispose (+9 more)
...
### Community 187 - "knowledge_screen.dart"
Cohesion: 0.06
Nodes (31): ../../../core/models/knowledge/merchant_knowledge.dart, MerchantKnowledge, body, build, _buildFilterSegments, _buildHeroMetricsCard, _buildMerchantList, _buildSearchField (+23 more)
...
### Community 195 - "Color"
Cohesion: 0.07
Nodes (27): Color, AppColorsExtension, AppDialog, build, cancelText, confirmColor, confirmText, content (+19 more)

### Community 196 - "user_profile.dart"
Cohesion: 0.13
...
### Community 202 - "../core/theme/app_typography.dart"
Cohesion: 0.10
Nodes (26): ../../../core/providers/fuel_price_provider.dart, ../core/theme/app_animations.dart, ../core/theme/app_typography.dart, ../../core/widgets/nexus_inline_loading.dart, FuelPriceProvider, _apiKeyController, build, _buildGlassField (+18 more)
...
### Community 213 - "goal_service.dart"
Cohesion: 0.15
Nodes (12): addContribution, addGoal, clearAllGoals, deleteGoal, _firestore, _goalsCollection, GoalService, _requireUserId (+4 more)
...
### Community 218 - "../core/theme/app_colors.dart"
Cohesion: 0.08
Nodes (28): ../core/theme/app_colors.dart, ../core/theme/app_spacing.dart, ../../core/widgets/nexus_switch.dart, ../core/widgets/top_snackbar.dart, AboutScreen, _AboutScreenState, build, _buildActionRow (+20 more)

### Community 219 - "slice_statement_parser.dart"
Cohesion: 0.18
Nodes (10): bank_statement_parser.dart, bankLabel, canParse, _dateStart, _extractMerchant, _junkLine, parse, _parseDate (+2 more)
...
Cohesion: 0.05
Nodes (41): FirebaseFirestore, ledger_service.dart, CascadeService, deleteAccountAndTransactions, _firestore, addTransactionAndUpdateBalance, addTransferAndUpdateBalances, _applyBudgetUpdate (+33 more)
...
Cohesion: 0.13
Nodes (18): ../../core/models/notification.dart, ../../core/providers/notification_provider.dart, NotificationProvider, _save, build, _buildEmptyState, _buildGroupedList, _buildNotificationTile (+10 more)
...
### Community 245 - "bike_image_utils.dart"
Cohesion: 0.33
...
### Community 264 - "modern_more_screen.dart"
Cohesion: 0.08
Nodes (23): about_screen.dart, ../backup/backup_settings_screen.dart, ../../core/providers/biometric_provider.dart, ../core/services/auth_service.dart, ../family/screens/expense_splitter_screen.dart, ../family/screens/family_dashboard_screen.dart, ../gmail/nbox_sync_screen.dart, ../knowledge/knowledge_screen.dart (+15 more)

### Community 265 - "SharedExpenseProvider"
Cohesion: 0.22
Nodes (9): SharedExpenseProvider, _deleteExpense, _editMember, initState, _removeMember, _addManualMember, _addRegisteredUser, initState (+1 more)
...
### Community 282 - "google_drive_service.dart"
Cohesion: 0.10
Nodes (19): GoogleSignIn, _challansFolderId, _challansFolderName, _createSubfolder, deleteFile, _ensureFoldersExist, _getDriveApi, getGoogleDriveFileUrl (+11 more)
...
### Community 290 - "Nexus Remediation Log"
Cohesion: 0.20
Nodes (9): 2026-09-05 — canonical commit and Family & Friends pass, 2026-09-05 — P0 foundation pass, 2026-09-06 — repository cleanup and validation pass, Nexus Remediation Log, Remaining blockers, Remaining work, Validation, Validation (+1 more)

### Community 291 - "upcoming_week_widget.dart"
Cohesion: 0.12
...
### Community 299 - "padding-y"
Cohesion: 0.67
Nodes (4): padding-y, padding-y, $type, $value

### Community 300 - "payday_checklist_service.dart"
Cohesion: 0.09
...
Cohesion: 0.11
Nodes (19): ../../core/widgets/collapsible_fab.dart, _budgetPriorityScore, build, _buildBentoBudgetGrid, _buildBentoTile, _buildEmptyState, _buildMiniStat, _buildOverviewCard (+11 more)

### Community 304 - "CodeRabbit Code Review"
Cohesion: 0.17
Nodes (11): 1. Check Prerequisites, 2. Run Review, 3. Present Results, 4. Fix Issues (Autonomous Workflow), 5. Review Specific Changes, Capabilities, CodeRabbit Code Review, Documentation (+3 more)

### Community 305 - "add_subscription.dart"
Cohesion: 0.10
...
### Community 306 - "package:flutter/material.dart"
Cohesion: 0.11
Nodes (16): Category, color, emoji, fromMap, id, isCustom, isModified, name (+8 more)

### Community 307 - "garage_dashboard_widget.dart"
Cohesion: 0.11
Nodes (17): ../../core/models/bike.dart, build, color, _EmptyGarageCard, _formatCost, _formatOdo, fuelEntries, GarageDashboardWidget (+9 more)
...
Cohesion: 0.13
Nodes (15): build, _buildDialogDetailRow, _buildLoadingState, _buildPatternTile, createState, _createSubscription, _detectedPatterns, _getConfidenceColor (+7 more)

### Community 341 - "transaction_understanding_test.dart"
Cohesion: 0.18
Nodes (9): package:flutter_test/flutter_test.dart, package:nexus/core/models/detected_transaction.dart, package:nexus/core/models/transaction.dart, package:nexus/core/models/transaction_draft.dart, package:nexus/core/models/transaction_understanding.dart, package:nexus/core/services/transaction_router.dart, _detected, main (+1 more)

### Community 342 - "destructive"
Cohesion: 0.67
Nodes (3): destructive, $type, $value

### Community 343 - "debts_screen_test.dart"
Cohesion: 0.12
Nodes (15): package:nexus/core/models/debt.dart, package:nexus/core/providers/debt_provider.dart, package:nexus/modules/debts/debts_screen.dart, addDebt, clear, clearAllData, debts, deleteDebt (+7 more)

### Community 344 - "log_subscription_payment_modal.dart"
Cohesion: 0.10
Nodes (19): ../../core/models/transaction_draft.dart, _amountController, build, _buildActions, _buildContent, _buildHeader, _controller, createState (+11 more)
...
### Community 346 - "package:firebase_auth/firebase_auth.dart"
Cohesion: 0.14
Nodes (12): _loadUser, _user, addInvestment, deleteInvestment, _firestore, _investmentsCollection, InvestmentService, _requireUserId (+4 more)

### Community 347 - "ring"
Cohesion: 0.67
Nodes (3): ring, $type, $value

### Community 348 - "challan_service.dart"
Cohesion: 0.14
Nodes (13): _challansCollection, ChallanService, createChallan, deleteChallan, _firestore, getExpiringChallans, getOverdueChallans, getTotalPendingFines (+5 more)
...
### Community 350 - "translucent_app_bar.dart"
Cohesion: 0.18
Nodes (11): dart:ui, actions, automaticallyImplyLeading, bottom, build, leading, preferredSize, title (+3 more)

### Community 351 - "firestore_service.dart"
Cohesion: 0.14
Nodes (13): createAccount, createDebt, currentUserId, deleteDebt, _firestore, FirestoreService, getAccountsStream, _getCollection (+5 more)

### Community 352 - "manage_categories_screen.dart"
Cohesion: 0.15
Nodes (13): ../../../../core/models/category.dart, ../../core/widgets/nexus_card.dart, _activeFilter, build, _buildCategoryTile, _buildFilterChip, _buildHiddenCategoryTile, _buildStatPill (+5 more)
...
### Community 354 - "subscription_service.dart"
Cohesion: 0.15
Nodes (12): addSubscription, clearAllSubscriptions, deleteSubscription, _firestore, _requireUserId, restoreSubscriptions, _subscriptionsCollection, SubscriptionService (+4 more)

### Community 355 - "package:flutter/foundation.dart"
Cohesion: 0.18
Nodes (9): isPopupActiveNotifier, DefaultFirebaseOptions, ios, macos, web, windows, package:firebase_core/firebase_core.dart, package:flutter/foundation.dart (+1 more)
...
### Community 358 - "String? get"
Cohesion: 0.18
Nodes (10): bankLabel, BankStatementParser, canParse, makeFingerprint, parse, parseAmount, IdfcStatementParser, SbiStatementParser (+2 more)

### Community 359 - "MaterialPageRoute"
Cohesion: 0.18
Nodes (11): _importStatement, _navigateToGarageManagement, _showEditEntryDialog, build, _buildSettingsSection, _buildSupportSection, _buildToolsGrid, _navigate (+3 more)

### Community 360 - "BiometricProvider"
Cohesion: 0.22
Nodes (10): _initializeAuthenticatedApp, BiometricProvider, BiometricProtectedAction, initState, _ModernMoreScreenState, initState, _ModernMoreScreenState, _buildLockScreen (+2 more)

### Community 361 - "legacy_data_migration_service.dart"
Cohesion: 0.25
Nodes (7): FirebaseAuth, _auth, _firestore, LegacyDataMigrationService, _migrateCollection, migrateIfNeeded, _migrationVersion

### Community 362 - "bool get"
Cohesion: 0.33
Nodes (6): bool get, hasSideEffects, icon, label, TransactionIntent, TransactionIntentX
...
### Community 364 - "List"
Cohesion: 0.40
Nodes (4): elementAtOrNull, ListExtension, ListExtension, List
...
## Knowledge Gaps
- **5248 isolated node(s):** `fs`, `path`, `fs`, `path`, `fs` (+5243 more)
...
- **Why does `detect_domain()` connect `detect_domain` to `design_system.py`, `search`?**
  _High betweenness centrality (0.008) - this node is a cross-community bridge._
- **What connects `fs`, `path`, `fs` to the rest of the system?**
  _5248 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `BikeProvider` be split into smaller, more focused modules?**
