            ...
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                ...
                _buildGlassCard(
                  context,
                  child: Text(
                    "Nexus is built on the belief that you know your money best. No black-box decisions, just powerful, precision tools wrapped in a stunning, distraction-free interface. Take absolute control of your financial destiny with clarity and confidence.",
                    style: TextStyle(
