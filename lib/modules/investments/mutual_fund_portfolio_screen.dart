      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: AppSpacing.md),
            Text(
              'Start your investment journey by adding your first mutual fund',
              style: AppTypography.bodyLarge.copyWith(
                color: AppColors.textSecondary,
              ),
              textAlign: TextAlign.center,
                ...
                Row(
                  ...
                  children: [
                    ...
                    if (sip.gainLoss != null &&
                        sip.gainLossPercentage != null &&
                        sip.gainLossPercentage!.abs() >= 0.01 &&
                        sip.gainLossPercentage!.isFinite)
                      Container(
                        padding: const EdgeInsets.symmetric(
