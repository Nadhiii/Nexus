    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          // Merchant List
          Expanded(child: _buildMerchantList(knowledgeProvider)),
        ],
      ),
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return _MerchantCard(
              ...
              onEdit: () =>
                  _showEditKnowledgeDialog(context, provider, merchant),
            );
          },
        );
      },
          ...
          child: Column(
            ...
            children: [
              _InfoItem(
                ...
                description:
                    'Nexus learns from every transaction you approve. Over time, it recognizes patterns and auto-categorizes.',
              ),
              const SizedBox(height: 16),
              _InfoItem(
                icon: Icons.edit,
                ...
                description:
                    'You can manually teach Nexus about merchants using the + button. This is useful for new merchants.',
              ),
              const SizedBox(height: 16),
              _InfoItem(
                ...
                description:
                    'Toggle off any learned knowledge that\'s incorrect. Nexus will stop using it for auto-categorization.',
              ),
              const SizedBox(height: 16),
              _InfoItem(
                ...
                description:
                    'Remove incorrect knowledge entirely. This doesn\'t delete transactions, just what Nexus learned.',
              ),
            ],
          ),
        ),
        ...
        builder: (context, setDialogState) => AlertDialog(
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(
                  'Enter a merchant name to teach Nexus:',
                  style: AppTypography.bodyMedium.copyWith(
                    color: AppColors.textSecondary,
                  ),
                ),
            ...
            ElevatedButton(
              onPressed: () async {
                ...
                final knowledge = MerchantKnowledge(
                  ...
                  defaultCategoryId: selectedCategory ?? 'Uncategorized',
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 8),
            Text(
              'Recurring: ${merchant.isRecurring ? "Yes" : "No"}',
              style: AppTypography.bodyMedium.copyWith(
                color: AppColors.textPrimary,
              ),
            ),
            const SizedBox(height: 8),
            Text(
              'Times seen: ${merchant.occurrenceCount}',
              style: AppTypography.bodyMedium.copyWith(
                color: AppColors.textPrimary,
              ),
            ),
